...
+proposal_response(name(Name), type(Type), price(Price), est_up(Est_up), est_down(Est_down), response(Response))[source(A)]: threshold(Threshold) & (Price - Est_down) <= Threshold & A == trading
